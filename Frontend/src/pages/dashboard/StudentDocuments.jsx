        ...
        <div className="overflow-x-auto">
          <table className="min-w-full divide-y divide-gray-200">
            <thead className="bg-gray-50">
              <tr>
                <th className="px-4 md:px-6 py-2 md:py-3 text-left text-xs font-medium text-gray-500 uppercase">Document Name</th>
                ...
                <th className="px-4 md:px-6 py-2 md:py-3 text-left text-xs font-medium text-gray-500 uppercase">Signature</th>
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {documents.map((doc) => (
                <tr key={doc.id}>
                  ...
                  <td className="px-4 md:px-6 py-3 md:py-4 whitespace-nowrap text-sm text-gray-900">{doc.type}</td>
                  <td className="px-4 md:px-6 py-3 md:py-4 whitespace-nowrap">
