...
const LandingPage = () => {
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 hover:shadow-2xl transition-all transform hover:-translate-y-2 border border-gray-100">
            ...
            <div className="space-y-4">
              <div className="p-4 bg-gray-50 rounded-lg">
                ...
                <p className="text-sm text-gray-600">"Amazing platform that helped me track my progress and land my dream job!"</p>
              </div>
              <div className="p-4 bg-gray-50 rounded-lg">
                <div className="flex items-center mb-2">
                ...
                <p className="text-sm text-gray-600">"Excellent mentorship and career guidance. Highly recommend!"</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 hover:shadow-2xl transition-all transform hover:-translate-y-2 border border-gray-100">
            <div className="flex items-center justify-between mb-6">
              <h3 className="text-xl font-semibold text-gray-800">Progress Analytics</h3>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                <div className="flex justify-between text-sm">
                  <span className="text-gray-600">Job Readiness</span>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                  ...
                  <span className="text-sm text-teal-600 font-medium">324</span>
                </div>
                <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                  <span className="text-sm text-gray-700">Group Workshops</span>
                  <span className="text-sm text-cyan-600 font-medium">28</span>
                </div>
              </div>
            </div>
          </div>
