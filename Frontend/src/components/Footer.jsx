      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center space-x-3 mb-6">
              ...
              <span className="font-semibold text-xl">Career Tracking Platform</span>
            </div>
            <p className="text-gray-400 mb-6 leading-relaxed">
              Empowering youth development organizations with comprehensive career tracking 
              and progression monitoring tools.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4 text-gray-400">
              <li><a href="#" className="hover:text-white transition-colors">Student Panel</a></li>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="text-gray-400">
                Get the latest updates on platform features, success stories, and best practices 
        ...
        <div className="mt-12 pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center">
          <div className="text-gray-400 mb-4 md:mb-0">
            © {currentYear} Y4D Career Tracking Platform. All rights reserved.
          </div>
